...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen relative overflow-hidden bg-background px-8 py-12">
      ...
      {/* Navigation */}
      <nav className="relative z-10 flex justify-end">
      ...
      <div className="relative z-10 flex min-h-[calc(100vh-6rem)]">
        ...
        <div className="flex-1 flex flex-col items-end justify-center text-right">
          <h1 className="text-6xl md:text-7xl lg:text-8xl font-extralight text-foreground tracking-tight mb-4">
            Kim Sacher
          </h1>
          <h2 className="text-xl md:text-2xl font-light text-foreground/70 tracking-wide mb-4">
            Software Engineering & Web Development
          </h2>
          <p className="text-sm text-foreground/50 font-light max-w-md mb-8">
